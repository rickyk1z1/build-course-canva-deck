...
8. **讲稿痕迹泄漏** — `讲稿`模式下,有没有把口播寒暄、转场废话、重复强调、录制提示或“根据讲稿整理”“这一段讲的是”“本段讲的是”这类处理痕迹写到屏显里?屏显应该像课程课件,不是讲稿摘要说明。
9. **讲稿提炼过度** — `讲稿`模式下,有没有为了少页数或更像大纲而丢掉讲稿的核心判断、关键例子、重要比喻或原有教学顺序?提炼是删口播冗余,不是重写成另一个课。
