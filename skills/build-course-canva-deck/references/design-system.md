...
- planned native motifs come from the selected template's `course.template_native_element_inventory`, show at least two distinct motif sources across a long deck, and do not repeat one element across most motif pages;
